...
public class PendingOrderChatAdapter extends BaseExpandableListAdapter {
    ...
    public PendingOrderChatAdapter(Activity context, ArrayList<Group> groupList) {
    ...
    private void setOtherChildView(final Child child, PendingOrderChatAdapter.ChildHolder holder) {
    ...
    private void setMyChildView(final Child child, final PendingOrderChatAdapter.ChildHolder holder) {
